...
import { BookOpen, CheckCircle, Clock, Target, Award, TrendingUp } from 'lucide-react';
...
const StudentDashboard = () => {
  ...
  const recommendedTopics = dashboardData?.recommended_topics || [
    ...
    <Layout allowedRoles={['student']}>
      <div className="container mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Track your progress and practice new topics</p>
        </div>
                  ...
                  {recommendedTopics.map((topic: Topic) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button className="text-sm text-blue-600 font-medium">Practice</button>
                      </div>
                    </div>
                  ))}
                </div>
                    ...
                    <div className="flex items-start gap-4">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center text-sm text-gray-500">
                          <span className="mr-4">Topic: {question.topic.name}</span>
                      ...
                      <button className="text-blue-600 text-sm font-medium">Retry</button>
                    </div>
                  </div>
                ))}
              </div>
              <div className="px-6 py-3 border-t border-gray-200 bg-gray-50">
                <button className="text-sm font-medium text-blue-600">View all questions</button>
              </div>
            </div>
          </div>
              ...
              <div className="p-6">
                <div className="h-64 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-900 font-medium mb-2">Keep up the good work!</p>
                    <p className="text-gray-600 text-sm">You've completed 32 questions this week.</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  {[1, 2, 3, 4, 5, 6, 7].map((day) => (
                    <div key={day} className="flex flex-col items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center mb-1 ${
                        day <= 5 ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-400'
                      }`}>
                        {day}
                      </div>
