// src/components/toast/ToastWithDismiss.tsx
import React from 'react';
import { Toast, toast } from 'react-hot-toast';

interface ToastWithDismissProps {
  t: Toast;
  message: string;
  type: 'success' | 'error' | 'info' | 'warning';
}

const ToastWithDismiss: React.FC<ToastWithDismissProps> = ({ t, message, type }) => {
  return (
    <div className="flex items-center justify-between gap-4 min-w-[300px] max-w-md">
